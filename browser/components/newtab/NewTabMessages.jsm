  ...
  handleContentRequest(actionName, {data, target}) {
    switch (actionName) {
      ...
      case ACTIONS.search.inSearch.suggestions:
        ...
        Task.spawn(function*() {
          try {
            ...
            let suggestions = yield NewTabSearchProvider.search.getSuggestions(engineName, searchString, target);
      ...
      case ACTIONS.search.inSearch.performSearch:
        Task.spawn(function*() {
          try {
            yield NewTabSearchProvider.search.performSearch(target, data);
          } catch (e) {
            Cu.reportError(e);
          }
        });
      ...
      case ACTIONS.search.inSearch.cycleEngine:
        NewTabSearchProvider.search.cycleEngine(data);
        break;
    }
  },
